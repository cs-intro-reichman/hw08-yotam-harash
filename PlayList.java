...
class PlayList {
    ...
    public int indexOf(String title) {
        ...
        for (int i = 0; i < this.size; i++) {
            if (title.toLowerCase().equals(this.tracks[i].getTitle().toLowerCase())) {
                return i;
            }
        }
        return -1;
    ...
    public void remove(String title) {
        ...
        int place=this.indexOf(title);
        if (place==-1||this.size==0) {
    ...
    public void sortedInPlace() {
        ...
        for (int i = 0; i < this.size; i++) {
            ...
            int place=this.minIndex(i);
            this.tracks[i]=this.tracks[place];
            this.tracks[place]=temp;
        }
    }
}
